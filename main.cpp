...
bool cmp_ffd(const std::pair<int, std::vector<std::string>>& p1, const std::pair<int, std::vector<std::string>>& p2) {
  return g_vm_info[p1.second[1]].cpu_core >= g_vm_info[p2.second[1]].cpu_core;
}
